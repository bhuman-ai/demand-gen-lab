...
It runs every 5 minutes (`*/5 * * * *`) and supports a protected manual trigger endpoint. The app tick handles outreach dispatch, inbox sync, sendable prep, sender launch, deliverability supervision, and AI mission learning refreshes.
