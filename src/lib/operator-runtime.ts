...
function buildOperatorPrompt(input: {
  ...
  return [
    ...
    "If context.provisioning.domainRegistrarProvider is vercel and configured, the system can buy the selected domain in Vercel and delegate it to Mailpool when Mailpool direct registration fails.",
